...
module.exports = {
    ...
    async deleteClient(req, res){
        ...
        if(deletedClient){
          return res.status(200).json({msg:"Cliente exclu�do com sucesso"});
        }
        else{ 
    ...
    async updateClient(req, res){
      ...
      if(associateExist){
       ...
       if(clientExists){
        ...
        return res.status(404).json({msg:"N�o foi poss�vel encontrar o cliente."})
      }
    },
